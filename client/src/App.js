...
import {
  CartCounterContext,
  CartCounterProvider,
} from "./components/context/CartCouter";
...
import UserSocketWrapper from "./components/Outlet";
function App() {
  // Token Evaluator
      ...
      <CartCounterProvider>
        <NotificationProvider>
          ...
          <Routes>
            ...
            <Route element={<UserSocketWrapper />}>
              <Route path="/Userpanel" element={<Userpanel />} />
              <Route
                path="/chat-room"
                element={<ChatRoom user={getUserID} />}
              />
            </Route>
            <Route
              path="/admin-chat"
              element={<AdminChat admin={getAdminId} />}
            />
